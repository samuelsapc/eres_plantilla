                  ...
                  <div className="card">
                     <div className="card-body">
                        <div className="post-details">
                           ...
                           <ul className="mb-4 post-meta d-flex ">
                              <li className="post-author mr-xl-3  mr-2">
                                 By Admin
                              </li>
                              <li className="post-date mr-xl-3  mr-2">
                                 <i className="fa fa-calender" />
                                 18 Nov 2020
                              </li>
                              <li className="post-comment mr-xl-3  mr-2">
