         ...
         <div className="page-titles">
            <ol className="breadcrumb">
               <li className="breadcrumb-item active">
                  <Link to="/patient-details">Settings</Link>
               </li>
               <li className="breadcrumb-item">
                  <Link to="/patient-details">Patient</Link>
               </li>
            </ol>
         </div>
         <div className="d-md-flex d-block mb-3 align-items-center">
               ...
               <ul className="timeline">
                  <li>
                     ...
                     >
                        ...
                        <p className="fs-14 mb-0 ">21/08/2020, 12:45 AM</p>
                     </Link>
                  </li>
            ...
            <Dropdown className="dropdown d-inline-block ml-auto mr-2">
               <Dropdown.Toggle
                  variant=""
                  type="button"
                  className="btn btn-outline-primary btn-rounded dropdown-toggle font-w600"
            ...
            <Link
               to="/patient-details"
               className="btn btn-primary btn-rounded wspace-no"
            >
               <i className="las scale5 la-pencil-alt mr-2" /> Edit
            </Link>
         </div>
         <div className="row">
            ...
            <div className="col-xl-3 col-xxl-4 col-md-6">
               <div className="card">
                  <div className="card-header border-0 pb-0">
                     <h4 className="fs-20 font-w600">Disease History</h4>
                  </div>
                  <div className="card-body">
            ...
            <div className="col-xl-3 col-xxl-12 col-md-6">
               <div className="card">
                  <div className="card-header border-0 pb-0">
                     <h4 className="fs-20 font-w600">Patient Statistic</h4>
                  </div>
                  <div className="card-body text-center">
                     ...
                     <div className="mt-4">
                        <p className="mb-2 d-flex text-dark font-w500  fs-14">
                           Immunities (24%)
                        ...
                        <p className="mb-2 d-flex text-dark font-w500  fs-14">
                           Heart Beat (41%)
                           <span className="pull-right ml-auto">12</span>
                        </p>
                        <div className="progress mb-3" style={{ height: 8 }}>
                           <div
                        ...
                        <p className="mb-2 d-flex  text-dark font-w500 fs-14">
                           Weigth (15%)
                           <span className="pull-right ml-auto">15</span>
                        </p>
                        <div className="progress" style={{ height: 8 }}>
                           <div
                              className="progress-bar bg-light progress-animated"
               ...
               <div className="card">
                  ...
                  <div className="card-body">
                     <div className="media d-sm-flex text-sm-left d-block text-center">
                        <img
                           alt="image"
                           className="rounded mr-sm-4 mr-0 mb-2 mb-sm-0"
                           width={130}
                           src={avater02}
                        />
                        <div className="media-body">
                           ...
                           <p className="text-primary">Physical Therapy</p>
