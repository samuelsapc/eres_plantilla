   ...
   return (
      <>
         ...
         <div className="d-block d-sm-flex mb-3 mb-md-4">
            ...
            >
               <i className="lar la-calendar-plus mr-2 scale5 mr-2" />+ New
               Appointment
            </Link>
            <Dropdown className="dropdown ml-auto mr-1 d-inline-block">
               <Dropdown.Toggle
                  variant=""
                  type="button"
                  ...
                  <Slider {...settings}>
                     <div className="items">
                        <div className="media bg-white p-4 rounded align-items-center">
                           <img className="mr-3" src={doctors6} alt="" />
                           <div className="media-body d-block d-sm-flex  align-items-center justify-content-between">
                              ...
                              <div className="text-sm-right text-center mt-sm-0 mt-2">
                     ...
                     <div className="items">
                        <div className="media bg-white p-4 rounded align-items-center">
                           <img className="mr-3" src={doctors7} alt="" />
                           <div className="media-body d-block d-sm-flex  align-items-center justify-content-between">
                              <div className="mr-2">
                                 <h4 className="fs-20">
                                    <Link className="text-black" to="/reviews">
                     ...
                     <div className="items">
                        <div className="media bg-white p-4 rounded align-items-center">
                           <img className="mr-3" src={doctors8} alt="" />
                           <div className="media-body d-block d-sm-flex  align-items-center justify-content-between">
                              <div className="mr-2">
                                 <h4 className="fs-20">
                                    <Link className="text-black" to="/reviews">
